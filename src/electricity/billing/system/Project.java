...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        Image i3 = ic.getImage().getScaledInstance(820, 630,Image.SCALE_DEFAULT);
        ...
        /* ---- Pay Bill ---- */
        u1.setFont(new Font("arial",Font.PLAIN,12));
        ...
        /* ---- Bill Details ---- */
        u2.setFont(new Font("arial",Font.PLAIN,12));
        ...
        /* ---- Last Bill ----*/
        u3.setFont(new Font("arial",Font.PLAIN,12));
        ...
        /* ---- Report ---- */
        r1.setFont(new Font("arial",Font.PLAIN,12));
